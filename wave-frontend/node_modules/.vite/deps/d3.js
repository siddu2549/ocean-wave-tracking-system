...
function locale_default2(locale4) {
  var group2 = locale4.grouping === void 0 || locale4.thousands === void 0 ? identity_default5 : formatGroup_default2(map4.call(locale4.grouping, Number), locale4.thousands + ""), currencyPrefix = locale4.currency === void 0 ? "" : locale4.currency[0] + "", currencySuffix = locale4.currency === void 0 ? "" : locale4.currency[1] + "", decimal = locale4.decimal === void 0 ? "." : locale4.decimal + "", numerals = locale4.numerals === void 0 ? identity_default5 : formatNumerals_default2(map4.call(locale4.numerals, String)), percent = locale4.percent === void 0 ? "%" : locale4.percent + "", minus = locale4.minus === void 0 ? "-" : locale4.minus + "", nan = locale4.nan === void 0 ? "NaN" : locale4.nan + "";
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks2(start2, stop, count3) {
    ...
    const interval3 = count3 && typeof count3.range === "function" ? count3 : tickInterval(start2, stop, count3);
...
function pie_default() {
  var value = identity_default6, sortValues = descending_default, sort2 = null, startAngle = constant_default10(0), endAngle = constant_default10(tau7), padAngle = constant_default10(0);
  function pie(data) {
